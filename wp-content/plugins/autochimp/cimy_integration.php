...
//
function AC_FetchMappedCimyData( $userID )
{
	// User data array
	$dataArray = array();
			...
			if ( 0 === strcmp( $results[0]['TYPE'],"checkbox" ) )
			{
				...
				if ( 0 == strcmp( $value, 'YES' ) )
				{
					...
					foreach( $checkboxArray as &$cba )
					{
						...
						// stored in the "NAME" - Remember, that's becausse of these
						...
						if ( in_array( $field['option_value'], $cba ) )
						{
							...
							// Can't get my damn debugger to work!
							//print "<p>Updating</p>";
							//print_r( $cba );
							//print "<p>----</p>";
						}
